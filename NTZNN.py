...
def equation(t, state):
    ...
    dx11 = -gamma*(np.sin(t)*(np.sign(x11*np.sin(t)+x21*np.cos(t)-1))-np.cos(t)*(np.sign(x21*np.sin(t)-x11*np.cos(t))))+x21
    dx12 = -gamma*(np.sin(t)*(np.sign(x12*np.sin(t)+x22*np.cos(t)))-np.cos(t)*(np.sign(x22*np.sin(t)-x12*np.cos(t)-1)))+x22
    dx21 = -gamma*(np.cos(t)*(np.sign(x11*np.sin(t)+x21*np.cos(t)-1))+np.sin(t)*(np.sign(x21*np.sin(t)-x11*np.cos(t))))-x11
    dx22 = -gamma*(np.cos(t)*(np.sign(x12*np.sin(t)+x22*np.cos(t)))+np.sin(t)*(np.sign(x22*np.sin(t)-x12*np.cos(t)-1)))-x12
